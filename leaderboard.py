...
def highscore_add_to_highscore_list(nick, time_score, guessed_word):
    ...
    highscore_list.append((nick, str(time_score), "_".join(time_clock), guessed_word))
...
def highscores_add_to_file(nick, time_score, guessed_word):
    sorted_highscore_list = highscore_add_to_highscore_list(nick, time_score, guessed_word)
